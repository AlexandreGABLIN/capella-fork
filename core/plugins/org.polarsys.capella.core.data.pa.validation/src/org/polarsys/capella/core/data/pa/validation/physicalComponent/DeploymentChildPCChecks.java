    ...
    if (eType == EMFEventType.NULL) {
      ...
      if (eObj instanceof PhysicalComponent) {
        ...
        if (PhysicalComponentExt.isNode(currentElement)) {
          ...
          if (nodePC != null) {
              return ctx.createFailureStatus(NLS.bind(Messages.DeploymentChildPCChecks_2, CapellaElementExt.getValidationRuleMessagePrefix(currentElement), CapellaElementExt.getValidationRuleMessagePrefix(nodePC)));
          }
        }
      }
    }
