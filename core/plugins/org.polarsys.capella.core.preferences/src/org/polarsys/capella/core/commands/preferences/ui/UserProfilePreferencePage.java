...
public class UserProfilePreferencePage extends AbstractDefaultPreferencePage {
  ...
  private void createUserProfileGroup(Composite parent) {
    ...
    new Label(expertUserComposite, SWT.BEGINNING).setText(PreferencesUIMessages.UserProfilePreferencePage_0);
    ...
    new Label(userCompsite, SWT.BEGINNING).setText(PreferencesUIMessages.UserProfilePreferencePage_1);
