    ...
    try {
      ...
      if (null == session) {
        ...
        if (openSessionAction.getFailedOpeningSessions().containsKey(diagramFile)) {
          ...
          _sessionStatus =
              new Status(IStatus.ERROR, SiriusUIPlugin.getDefault().getPluginId(), NLS.bind(Messages.CapellaDashboardEditorInput_0, firstAnalysisFile,
      ...
      _sessionStatus =
          new Status(IStatus.ERROR, SiriusUIPlugin.getDefault().getPluginId(), NLS.bind(Messages.CapellaDashboardEditorInput_1, firstAnalysisFile,
              e.getMessage()), e);
