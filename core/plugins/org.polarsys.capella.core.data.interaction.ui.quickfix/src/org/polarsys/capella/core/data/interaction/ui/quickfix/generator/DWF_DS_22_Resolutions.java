...
public class DWF_DS_22_Resolutions extends AbstractMarkerResolutionGenerator {
  ...
  protected IMarkerResolution[] doGetResolutions(IMarker marker) {
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_22_Resolutions_0, stateFragment.getRelatedAbstractState()));
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_22_Resolutions_1, abstractFunction));
    ...
    // Delete.
    resolutions.add(new DeleteCommandResolver(Messages.DWF_DS_22_Resolutions_2, stateFragment));
  ...
  protected String getRuleId() {
    return "org.polarsys.capella.core.data.interaction.validation.DWF_DS_22"; //$NON-NLS-1$
  }
}
