...
public class DWF_DS_18_Resolutions extends AbstractMarkerResolutionGenerator {
  ...
  protected IMarkerResolution[] doGetResolutions(IMarker marker) {
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_18_Resolutions_0, invokedOperation));
    ...
    if (null != sequenceMessageSourceComponent) {
      ...
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_18_Resolutions_1, sequenceMessageSourceComponent));
    }
    ...
    if (null != sequenceMessageTargetComponent) {
      ...
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_18_Resolutions_2, sequenceMessageTargetComponent));
    }
    ...
    if (invokedOperation instanceof FunctionalExchange) {
      ...
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_18_Resolutions_3, sourceFunction));
      ...
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_18_Resolutions_4, targetFunction));
    ...
    if (null != exchangeSourceComponent) {
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_18_Resolutions_5, exchangeSourceComponent));
    }
    if (null != exchangeTargetComponent) {
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_18_Resolutions_6, exchangeTargetComponent));
    }
    ...
    resolutions.add(new DeleteCommandResolver(Messages.DWF_DS_18_Resolutions_7, elementToDelete));
