...
public class DWF_DS_04_Resolutions extends AbstractMarkerResolutionGenerator {
  ...
  protected IMarkerResolution[] doGetResolutions(IMarker marker) {
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_04_Resolutions_0, invokedOperation));
    ...
    if (null != sequenceMessageSourceComponent) {
      ...
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_04_Resolutions_1, sequenceMessageSourceComponent));
    }
    ...
    if (null != sequenceMessageTargetComponent) {
      ...
      resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_04_Resolutions_2, sequenceMessageTargetComponent));
    }
    ...
    if (invokedOperation instanceof ExchangeItemAllocation) {
      ...
      if (null != exchangeItem) {
        resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_04_Resolutions_3, exchangeItem));
      }
      // Interface
      Interface allocatingInterface = ((ExchangeItemAllocation) invokedOperation).getAllocatingInterface();
      if (null != allocatingInterface) {
        resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_04_Resolutions_4, allocatingInterface));
      }
    }
    ...
    // Delete.
    resolutions.add(new DeleteCommandResolver(Messages.DWF_DS_04_Resolutions_5, SequenceMessageExt.getStartedExecution(sequenceMessage)));
