...
public class DWF_DS_21_Resolutions extends AbstractMarkerResolutionGenerator {
  ...
  protected IMarkerResolution[] doGetResolutions(IMarker marker) {
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_21_Resolutions_0, stateFragment.getRelatedAbstractState()));
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.DWF_DS_21_Resolutions_1, component));
    ...
    // Delete.
    resolutions.add(new DeleteCommandResolver(Messages.DWF_DS_21_Resolutions_2, stateFragment));
  ...
  protected String getRuleId() {
    return "org.polarsys.capella.core.data.interaction.validation.DWF_DS_21"; //$NON-NLS-1$
  }
}
