  ...
  public IStatus validate(IValidationContext ctx) {
    ...
    if (eType == EMFEventType.NULL) {
      if (eObj instanceof AbstractFunction) {
        ...
        String currentFunctionName = NLS.bind(Messages.MDCHK_RootFunction_FunctionRealization_0, function.getName(),
            EObjectLabelProviderHelper.getMetaclassLabel(function, true));
        String targetFunctionName = ""; //$NON-NLS-1$
        ...
        if (previousArchitectures != null) {
          ...
          if (targetFunction != null) {
            targetFunctionName = NLS.bind(Messages.MDCHK_RootFunction_FunctionRealization_2, targetFunction.getName(),
