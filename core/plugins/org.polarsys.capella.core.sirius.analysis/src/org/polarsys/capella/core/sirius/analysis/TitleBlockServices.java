...
public class TitleBlockServices {
  ...
  private static final String DEFAULT_CELL_NAME = Messages.TitleBlockServices_0;
  private static final String DEFAULT_CELL_CONTENT = "feature:name"; //$NON-NLS-1$
  private static final String FILTERS_TITLE_BLOCKS_MESSAGE = "{0}s are hidden by filters. Do you want to deactivate the filters for {1}s?"; //$NON-NLS-1$
  private static final String FILTERS_DIALOG_TITLE = Messages.TitleBlockServices_4;
