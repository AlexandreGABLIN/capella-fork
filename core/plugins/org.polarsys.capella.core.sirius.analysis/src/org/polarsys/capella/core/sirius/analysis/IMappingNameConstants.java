...
public interface IMappingNameConstants {
  ...
  @Deprecated
  String INTERNAL_DATA_FLOW_LAYER_NAME = Messages.IMappingNameConstants_4;
  ...
  String MSM_COMPUTED_TRANSITION_MAPPING_NAME = "MSM_ComputedTransition"; //$NON-NLS-1$
  ...
  String HIDE_REGION_NAMES = "hide.region.names.filter"; //$NON-NLS-1$
  String DISPLAY_REGION_NAME_ON_ENTRY_EXIT_POINTS = "DisplayRegionNameOnEntryExitPoints"; //$NON-NLS-1$
  String SHOW_TRIGGER_SOURCE_FUNCTION = "show.triggerfe.source.filter"; //$NON-NLS-1$
  ...
  String OAIB_FUNCTIONAL_EXCHANGE_MAPPING_NAME = Messages.IMappingNameConstants_0;
  String OAIB_FUNCTION_MAPPING_NAME = Messages.IMappingNameConstants_1;
  ...
  String OAB_FUNCTIONAL_EXCHANGE_MAPPING_NAME = Messages.IMappingNameConstants_30;
  @Deprecated
  ...
  String ORB_FUNCTIONAL_EXCHANGE_MAPPING_NAME = Messages.IMappingNameConstants_40;
  ...
  String COAI_INTERACTION_MAPPING_NAME = Messages.IMappingNameConstants_43;
  String COAI_OPERATIONAL_ACTIVITY_MAPPING_NAME = Messages.IMappingNameConstants_44;
  String COAI_OPERATIONAL_ACTIVITY_IMPORT_MAPPING_NAME = Messages.IMappingNameConstants_45;
  String COAI_OPERATIONAL_ACTIVITY_IMPORT_SUB_MAPPING_NAME = Messages.IMappingNameConstants_46;
  ...
  String CDB_DATA_TYPE_CONTENTS_MAPPING_NAME = Messages.IMappingNameConstants_57;
  String CDB_DATA_TYPE_UNITS_MAPPING_NAME = Messages.IMappingNameConstants_58;
  ...
  String DT_TITLE_BLOCK_CONTAINER = "DT_TitleBlockContainer"; //$NON-NLS-1$
  String DT_TITLE_BLOCK_LINE_CONTAINER = "DT_TitleBlockLineContainer"; //$NON-NLS-1$
  String DT_TITLE_BLOCK_COLUMN_CONTAINER = "DT_TitleBlockColumnContainer"; //$NON-NLS-1$
  String DT_TITLE_BLOCK_CELL = "DT_TitleBlockCellNode"; //$NON-NLS-1$
  String DT_TITLE_BLOCK_EDGE = "DT_TitleBlockEdge"; //$NON-NLS-1$
   ...
   * System Analysis
   */
  String SAB_SYSTEM_MAPPING_NAME = Messages.IMappingNameConstants_76;
  String SAB_ACTOR_MAPPING_NAME = Messages.IMappingNameConstants_77;
  String SAB_SYSTEM_FUNCTION_MAPPING_NAME = Messages.IMappingNameConstants_78;
  String SAB_CONTROL_NODE_MAPPING_NAME = Messages.IMappingNameConstants_79;
  String SAB_FUNCTION_PORT_MAPPING_NAME = Messages.IMappingNameConstants_80;

  String SAB_FUNCTION_PORT_ALLOCATION_MAPPING_NAME = Messages.IMappingNameConstants_81;
  String LAB_FUNCTION_PORT_ALLOCATION_MAPPING_NAME = Messages.IMappingNameConstants_82;
  String PAB_FUNCTION_PORT_ALLOCATION_MAPPING_NAME = Messages.IMappingNameConstants_83;

  String SAB_COMPONENT_PORT_MAPPING_NAME = Messages.IMappingNameConstants_84;
  String SAB_CONNECTION_MAPPING_NAME = Messages.IMappingNameConstants_85;
  ...
  String SAB_FUNCTIONAL_EXCHANGE_MAPPING_NAME = Messages.IMappingNameConstants_2;
   ...
   */
  String LAB_LOGICAL_COMPONENT_MAPPING_NAME = Messages.IMappingNameConstants_3;
  String LAB_LOGICAL_FUNCTION_MAPPING_NAME = Messages.IMappingNameConstants_5;
  String LAB_CONTROL_NODE_MAPPING_NAME = Messages.IMappingNameConstants_126;
  String LAB_FUNCTION_PORT_MAPPING_NAME = Messages.IMappingNameConstants_127;
  String LAB_FUNCTIONAL_EXCHANGE_MAPPING_NAME = Messages.IMappingNameConstants_128;
  String LAB_COMPONENT_PORT_MAPPING_NAME = Messages.IMappingNameConstants_129;
  String LAB_CONNECTION_MAPPING_NAME = Messages.IMappingNameConstants_130;
  String LAB_EXCHANGE_CATEGORY_INPUTPORT_MAPPING_NAME = Messages.IMappingNameConstants_131;
  String LAB_EXCHANGE_CATEGORY_OUTPUTPORT_MAPPING_NAME = Messages.IMappingNameConstants_132;
  String LAB_EXCHANGE_CATEGORY_MAPPING_NAME = Messages.IMappingNameConstants_133;
  ...
  String LAB_COMPUTED_COMPONENT_EXCHANGE = "LAB_ComputedComponentExchange"; //$NON-NLS-1$
  String LAB_COMPUTED_PHYSICAL_LINK = "LAB_ComputedPhysicalLink"; //$NON-NLS-1$
  ...
  String LAB_DIAGRAM = Messages.IMappingNameConstants_169;
  ...
  String PAB_DIAGRAM = Messages.IMappingNameConstants_216;
  ...
  // filters
  String HIDE_ALL_PARAMETER = "hide.exchange.items.details.in.interfaces.filter"; //$NON-NLS-1$
  String HIDE_OPERATION_PARAMETER = Messages.IMappingNameConstants_6;
  String SHOW_EXCHANGE_ITEMS = "show.exchange.items.filter"; //$NON-NLS-1$
  String SHOW_FUNCTIONAL_EXCHANGES = "show.functional.exchanges.filter"; //$NON-NLS-1$
  String SHOW_EXCHANGE_ITEMS_PARAMETERS = "show.exchange.items.parameters.filter"; //$NON-NLS-1$
  String SHOW_EXCHANGE_ITEMS_ON_CE = "show.exchange.items.on.component.exchanges.filter"; //$NON-NLS-1$
  String SHOW_EXCHANGE_ITEMS_ON_CE_WITH_OUT_FE = "show.exchange.items.on.component.exchange.without.functional.exchanges.filter"; //$NON-NLS-1$
  String SHOW_FE_ON_CE = "show.allocated.functional.exchanges.on.component.exchanges.filter"; //$NON-NLS-1$
  String HIDE_CROSS_FE_IN_MULTIPART = "hide.cross.functional.exchanges.of.reusable.components.filter"; //$NON-NLS-1$
  String HIDE_ASSOCIATION_LABELS = "hide.association.labels.filter"; //$NON-NLS-1$
  String HIDE_ROLE_LABELS = "hide.role.labels.filter"; //$NON-NLS-1$
  String SHOW_MODIFIERS = "show.modifiers.filter"; //$NON-NLS-1$
  String HIDE_ROLE_NAMES = "hide.role.names.filter"; //$NON-NLS-1$
  String HIDE_FUNCTIONAL_EXCHANGES_NAMES = "hide.functional.exchanges.names.filter"; //$NON-NLS-1$
  String HIDE_COMPONENT_EXCHANGES_NAMES = "hide.component.exchanges.names.filter"; //$NON-NLS-1$
  String HIDE_PHYSICAL_LINKS_NAMES = "hide.physical.links.names.filter"; //$NON-NLS-1$
  String HIDE_INTERACTIONS_NAMES = "hide.interactions.names.filter"; //$NON-NLS-1$
  String HIDE_COMMUNICATION_MEANS_NAMES = "hide.communication.means.names.filter"; //$NON-NLS-1$
  String SHOW_FUNCTIONAL_EXCHANGES_ECHANGE_ITEMS = "show.functional.exchanges.exchange.items.filter"; //$NON-NLS-1$
  String SHOW_COMPONENT_EXCHANGES_ECHANGE_ITEMS = "show.component.exchanges.exchange.items.filter"; //$NON-NLS-1$
  String HIDE_CE_BY_DELEGATION = "hide.simplified.diagram.based.component.exchanges.filter"; //$NON-NLS-1$
  String HIDE_CE_BY_GROUP = "hide.simplified.group.of.component.exchanges.filter"; //$NON-NLS-1$
  String HIDE_CE_BY_GROUP_ORIENTED = "hide.simplified.oriented.grouped.component.exchanges.filter"; //$NON-NLS-1$
  String HIDE_OVERLAPPED_PHYSICAL_PATHS_ICON = "hide.overlappedphysical.paths.icon.filter"; //$NON-NLS-1$
  String HIDE_OVERLAPPED_PHYSICAL_PATHS_LABEL = "hide.overlappedphysical.paths.label.filter"; //$NON-NLS-1$
  String HIDE_OVERLAPPED_FUNCTIONAL_CHAINS_ICON = "hide.overlappedfunctional.chains.icon.filter"; //$NON-NLS-1$
  String HIDE_OVERLAPPED_FUNCTIONAL_CHAINS_LABEL = "hide.overlappedfunctional.chains.label.filter"; //$NON-NLS-1$
  
  String SHOW_FUNCTIONAL_EXCHANGES_PARAMS = "show.functional.exchanges.parameters.filter"; //$NON-NLS-1$
  String SHOW_FUNCTIONAL_EXCHANGES_ECHANGE_ITEMS_PARAMS = "show.functional.exchanges.exchange.items.parameters.filter"; //$NON-NLS-1$
  String CDB_SHOW_FULL_PATH = "show.full.path.filter"; //$NON-NLS-1$
  String SHOW_CONTEXTUAL_ELEMENTS = Messages.IMappingNameConstants_327;

  String MERGE_ASSOCIATED_FE_AND_SL = "merge.associated.functional.exchange.involvements.and.sequence.links.without.control.node.filter"; //$NON-NLS-1$

  // EPBS Architecture
  String EAB_CI = Messages.IMappingNameConstants_329;
  ...
  String CRB_CAPABILITY_REALIZATION_MAPPING = Messages.IMappingNameConstants_333;
  String CRB_COMPONENT_MAPPING = Messages.IMappingNameConstants_334;
  String CRB_INVOLVEMENT_MAPPING = Messages.IMappingNameConstants_335;
  String CRB_EXTENDS_MAPPING = Messages.IMappingNameConstants_336;
  String CRB_INCLIDE_MAPPING = Messages.IMappingNameConstants_337;
  String CRB_CAP_GENERALIZATION_MAPPING = Messages.IMappingNameConstants_338;
  String CRB_ACTOR_GENERALIZATION_MAPPING = Messages.IMappingNameConstants_339;

  // Interface Scenario
  String IS_CONSTRAINT_MAPPING = Messages.IMappingNameConstants_340;
  String IS_CONSTRAINT_ELEMENT_MAPPING = "Scenario_ContrainedElements"; //$NON-NLS-1$
  String IS_HIDE_CALL_ARGUMENTS = "hide.call.arguments.filter"; //$NON-NLS-1$
  String OAB_ROLE_MAPPING_NAME = "OAB_subRoles"; //$NON-NLS-1$
  String ORB_ROLE_MAPPING_NAME = "ORB_Role1"; //$NON-NLS-1$

  // additions 15/02/2012
  String SHOW_COMPONENT_EXCHANGES_PARAMS = "show.ce.param.filter"; //$NON-NLS-1$
  String SHOW_COMPONENT_EXCHANGES_EXCHANGE_ITEMS_PARAMS = "show.ce.ei.param.filter"; //$NON-NLS-1$

  // FunctionalChainDescription
  String FCD_DIAGRAM = Messages.IMappingNameConstants_347;
  ...
  String FCD_CHAIN_REFERENCE_CHAIN__MAPPING_NAME = "FC_FunctionalChainStacked"; //$NON-NLS-1$
  ...
  // Exchange context
  String SHOW_EXCHANGE_CONTEXT = "show.exchange.context.filter"; //$NON-NLS-1$
  String SHOW_CE_EXCHANGE_CONTEXT = "show.ce.exchange.context.filter"; //$NON-NLS-1$
  String SHOW_FE_EXCHANGE_CONTEXT = "show.fe.exchange.context.filter"; //$NON-NLS-1$
  String SHOW_EI_EXCHANGE_CONTEXT = "show.ei.exchange.context.filter"; //$NON-NLS-1$

  // Contextual Capability Realization Involvement Diagram
  String CCRI_COMPONENT = Messages.IMappingNameConstants_368;
  String CCRI_CAPABILITY_REALIZATION = "CCRI CapabilityRealization"; //$NON-NLS-1$
  String CCRI_CAPABILITY_REALIZATION_INVOLVEMENT = Messages.IMappingNameConstants_370;
