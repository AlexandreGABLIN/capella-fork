...
public class SelectOrCreateFunctionalExchangeDialog extends SelectElementsDialog {
  ...
  public SelectOrCreateFunctionalExchangeDialog(Shell parentShell, Set<FunctionalExchange> availableFEs,
    ...
    super(parentShell, Messages.SelectOrCreateFunctionalExchangeDialog_1, Messages.SelectOrCreateFunctionalExchangeDialog_2, availableFEs);
  ...
  public void createCreationForm(Composite parent) {
    ...
    creationGroup.setText(Messages.SelectOrCreateFunctionalExchangeDialog_3);
    ...
    creationChecker.setText(Messages.SelectOrCreateFunctionalExchangeDialog_4);
  ...
  private AbstractFunction selectAbstractFunction(Set<AbstractFunction> availableSourceFunctions2, String mesage) {
    SelectElementsDialog dialog = new SelectElementsDialog(parentShell, Messages.SelectOrCreateFunctionalExchangeDialog_8, mesage, availableSourceFunctions2);
    if (dialog.open() == OK) {
