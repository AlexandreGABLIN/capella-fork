  ...
  public IStatus validate(Object newValue, IPropertyContext context) {
    try {
      if (newValue != null) {
        ...
        if ((validOnEmpty != null) && Messages.StringPropertyValueProperty_0.equals(validOnEmpty) && (value.length() == 0)) {
          return new Status(IStatus.ERROR, getId(), Messages.StringPropertyValueProperty_1);
        }
      }
